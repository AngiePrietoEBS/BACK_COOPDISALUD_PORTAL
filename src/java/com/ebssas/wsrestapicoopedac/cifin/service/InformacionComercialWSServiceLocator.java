...
public class InformacionComercialWSServiceLocator extends org.apache.axis.client.Service implements InformacionComercialWSService {
    ...
    public InformacionComercialWS getInformacionComercial() throws ServiceException {
    ...
    public InformacionComercialWS getInformacionComercial(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            InformacionComercialSoapBindingStub _stub = new InformacionComercialSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (InformacionComercialWS.class.isAssignableFrom(serviceEndpointInterface)) {
                InformacionComercialSoapBindingStub _stub = new InformacionComercialSoapBindingStub(new java.net.URL(InformacionComercial_address), this);
                _stub.setPortName(getInformacionComercialWSDDServiceName());
                return _stub;
            }
