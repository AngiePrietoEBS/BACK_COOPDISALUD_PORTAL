 ...
 */
public class ProdcutosCygnusServiceBean
{
    ...
    private final ConsumoWSProductoCygnus consumoWSProductoCygnus;

        public ProdcutosCygnusServiceBean() {
        this.consumoWSProductoCygnus = new ConsumoWSProductoCygnus("http://129.158.242.142/WsProductosCygnus/WsProductosCygnus.asmx?wsdl");
    }
    ...
    public RespuestaCodeudor deudor_codeudor(String pwsIdentificacion) {
        
        RespuestaCodeudor respuestaCodeudor = new RespuestaCodeudor();
    
            respuestaCodeudor = this.consumoWSProductoCygnus.deudor_codeudor(pwsIdentificacion, "coopedac", "sysadm", "E3C720DA4004");
            try {
                if (respuestaCodeudor != null) {
