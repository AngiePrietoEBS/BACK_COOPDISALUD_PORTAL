...
public class RequestSimuladorCredito {
    ...
    public String toString() {
        return "RequestSimuladorCredito{" + "sMonto=" + sMonto + ", sNroCuota=" + sNroCuota + ", sCodCredito=" + sCodCredito + ", sIdentificacion=" + sIdentificacion + ", xsFormaPeriodicidad=" + xsFormaPeriodicidad + '}';
    }
}
